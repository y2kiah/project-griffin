...
void griffin::game::SkySystem::updateFrameTick(Game& game, Engine& engine, const UpdateInfo& ui)
{
	// this function could implement changing sky conditions
}


void griffin::game::SkySystem::init(Game& game, const Engine& engine, const SDLApplication& app)
{
