...
namespace griffin {
	 ...
	 */
	template <typename T>
	IdSet_T handle_map<T>::createItems(int n)
	{
		IdSet_T outerIds(n);
	 ...
	 */
	template <typename T>
	void handle_map<T>::removeItem(Id_T outerId)
	{
	 ...
	 */
	template <typename T>
	inline T& handle_map<T>::getItem(Id_T outerId)
	{
		Id_T innerId = m_sparseIds[outerId.index];
